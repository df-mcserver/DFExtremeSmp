...
public abstract class DFRecipeCreator {
    private final String idTag = "-dfesmp-recipes";
    List<Recipe> recipesToAdd = new ArrayList<>();
    static List<NamespacedKey> namespacedKeysToDiscover = new ArrayList<>();

    public final DFExtremeSmp plugin;

    public DFRecipeCreator(DFExtremeSmp plugin) {
        this.plugin = plugin;
    ...
    public CampfireRecipe createCampfireRecipe(Material source, ItemStack result, Float exp, int time, String extra) {
    ...
    public CampfireRecipe createCampfireRecipe(Material source, ItemStack result, Float exp, int time) {
        return createCampfireRecipe(source, result, exp, time, "");
    }
